    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-tada-our-paper-snap-towards-segmenting-anything-in-any-point-cloud-is-accepted-to-3dv-2026-as-an-oral-presentation-we-re-also-honored-that-snap-was-selected-as-one-of-the-best-paper-candidates",
          title: ':tada: Our paper SNAP: Towards Segmenting Anything in Any Point Cloud is accepted...',
          description: "",
          section: "News",},{id: "news-i-m-excited-to-announce-that-i-ve-joined-merl-as-a-research-intern-working-with-pedro-miraldo",
          title: 'I’m excited to announce that I’ve joined MERL as a Research Intern, working...',
          description: "",
          section: "News",},{id: "news-i-m-excited-to-share-that-i-ll-be-starting-a-new-internship-at-skydio-on-the-autonomy-team-i-ll-be-working-with-peter-henry-and-veeresh-taranalli-on-state-estimation-using-visual-inertial-odometry-looking-forward-to-contributing-to-real-world-autonomy-systems-and-learning-from-an-incredible-team",
          title: 'I’m excited to share that I’ll be starting a new internship at Skydio...',
          description: "",
